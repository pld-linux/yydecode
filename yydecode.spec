...
Usenet. yydecode works almost identi cally to the infamous uudecode
program.
...
install {TODO,README,ChangeLog,NEWS,AUTHORS,COPYING} $RPM_BUILD_ROOT%{_datadir}/doc/%{name}-%{version}

gzip -9nf $RPM_BUILD_ROOT%{_mandir}/man1/* $RPM_BUILD_ROOT%{_datadir}/doc/%{name}-%{version}/*
